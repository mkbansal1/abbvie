window.styleConfiguration = {
  ...
  arrays: {
    "welcome.examples": [
      {
        text: "How does WKND generate revenue to support its platform?",
        image:
      ...
      {
        text: "List all sports activities supported by WKND",
        image:
          "https://business.adobe.com/media_13b8aa5dca19cdd998cecb707db107f22e52f4474.png?width=2000&format=webply&optimize=medium",
        backgroundColor: "#FFFFFF",
      },
      {
        text: "How can booking or scheduling be managed for surfing activities?",
        image:
      ...
      {
        text: "Does WKND Adventure provide equipment rental option?",
        image:
