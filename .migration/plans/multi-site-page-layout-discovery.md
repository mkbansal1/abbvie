# Site Discovery & Block Analysis Plan: Qulipta, Qulipta HCP, Rinvoq, and Rinvoq HCP
...
> **Action Required:** Saving `Blocks.md` and committing to Git requires **Execute mode**. Exit plan mode to proceed.
...
## Site-Level Page Inventory (Detailed)
...
| 6 | `/covid19` | Info Page |
| 7–15 | `/resources/*` (9 pages) | Resources |
...
- [x] Discover pages for qulipta.com (13 pages via sitemap)
- [x] Discover pages for quliptahcp.com (10 pages + 3 PDFs via sitemap)
- [x] Discover pages for rinvoq.com (~114 pages via navigation crawl)
- [x] Discover pages for rinvoqhcp.com (~41 pages + ~25 PDFs via sitemap)
- [x] Analyze block patterns on qulipta.com (homepage, product, stories, FAQ)
- [x] Analyze block patterns on quliptahcp.com (homepage, safety)
- [x] Analyze block patterns on rinvoq.com (homepage, AD landing, results, stories, resources, glossary, cost)
- [x] Analyze block patterns on rinvoqhcp.com (homepage, efficacy, dosing)
- [x] Catalog all unique blocks with variants (43 blocks, ~65 variants)
- [x] Assign complexity ratings (Low/Medium/High/Very High)
- [x] Estimate effort per block (53–73 days total)
- [x] Create block reuse matrix across all 4 sites
- [x] Define phased implementation priority (4 phases)
- [ ] **Save `Blocks.md` to repository and commit to Git** ← Requires Execute mode
- [ ] Proceed with migration (requires Execute mode → invoke site migration)
